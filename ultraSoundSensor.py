...
class distanceHCR04:
    ...
    def start(self):
        ...
        try:
            ...
            if self.debug:
                print("HCR04 start fout: ",E)
            return False
        
    def meet1Maal(self):
        """Meet 1 afstand met de HCR04 sensor"""
        try:
            ...
            if t < 0:
                return -1
            # return afstand
            return self.snelheid * t * 100 / (2 * 1000 * 1000)
         except Exception as E:
            if self.debug:
                print("HCR04 meet fout: ",E)
            return -1
            
    def meet(self):
        """Meet afstand met de HCR04 sensor"""
        try:
            tel = 0
            meetwaarden = []
            # lus metingen
